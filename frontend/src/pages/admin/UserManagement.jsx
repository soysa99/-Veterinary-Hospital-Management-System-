                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {filteredUsers.map((user) => (
                            <tr key={user._id} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${getRoleColor(user.isAdmin)}`}>
                    ...
                    <div className="relative top-20 mx-auto p-6 border w-full max-w-2xl shadow-lg rounded-lg bg-white">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-gray-900">Role: <span className={`px-2 py-1 rounded-full ${getRoleColor(selectedUser.isAdmin)}`}>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <h4 className="text-sm font-medium text-gray-700 mb-2">Pets</h4>
                                    <div className="space-y-2">
                                        {selectedUser.pets && selectedUser.pets.length > 0 ? (
                                            selectedUser.pets.map((pet, index) => (
                                                <div key={pet._id || index} className="flex justify-between items-center py-2 border-b border-gray-200 last:border-0">
                                                    <div>
                                                        <p className="text-sm font-medium text-gray-900">{pet.name}</p>
                                                        <p className="text-xs text-gray-500">{pet.type} - {pet.breed}</p>
                                                    </div>
                                                    <p className="text-sm text-gray-500">{pet.age} years</p>
                                                </div>
                                            ))
                                        ) : (
